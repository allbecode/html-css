                    ...
                    <?php foreach ($carros as $c): ?>
                        <?php if ($editId === (int)$c['id']): ?>
                            ...
                            <form method="post" action="../actions/update_carro.php">
                                <tr>
                                    <td data-label="Marca">
                                        <input type="text" name="marca" value="<?= esc($c['marca']) ?>" required>
                                    </td>
                                    <td data-label="Modelo">
                                        <input type="text" name="modelo" value="<?= esc($c['modelo']) ?>" required>
                                    </td>
                                    <td data-label="Ano">
                                        <input type="number" name="ano" value="<?= esc($c['ano']) ?>" required>
                                    </td>
                                    <td data-label="Placa">
                                        <input type="text" name="placa" value="<?= esc($c['placa']) ?>" required>
                                    </td>
                                    <td data-label="Renavan">
                                        <input type="text" name="renavan" value="<?= esc($c['renavan']) ?>">
                                    </td>
                                    <td data-label="Apelido">
                                        <input type="text" name="apelido" value="<?= esc($c['apelido']) ?>">
                                    </td>
                                    <td data-label="Ações">
                        ...
                        <?php else: ?>
                            ...
                            <tr>
                                ...
                                <td data-label="Ações">
                                    <a class="button-icon" href="cadastro_carros.php?edit=<?= $c['id'] ?>" title="Editar">✏️</a>
                                    <a class="button-icon" href="../actions/delete_carro.php?id=<?= $c['id'] ?>"
