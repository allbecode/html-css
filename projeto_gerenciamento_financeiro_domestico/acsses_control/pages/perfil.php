...
<form method="POST">
    Novo Email: <input type="email" name="email" value="<?= htmlspecialchars($usuario['email']) ?>" required><br><br>
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" action="../actions/excluir_dependente.php" style="display:inline;">
                            ...
                            <button type="submit" onclick="return confirm('Deseja realmente excluir este dependente?')">Excluir</button>
                        </form>
                    </td>
                </tr>
            <?php endforeach ?>
